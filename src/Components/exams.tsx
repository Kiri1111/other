...
//answ return instance.get(`posts`)
//             <h3>3 вопрос</h3>
//import axios from 'axios'
...
//answ return instance.post('comments', {body: 'kjskjjv sdkvskv'})  NOOOOOO
//             <h3>4 вопрос</h3>
//import axios from 'axios'
// import React, { useEffect, useState } from 'react'
// import ReactDOM from 'react-dom/client';
...
//answ:return instance.get<TodoType>(`todos/${todoId}`)
//             <h3>8 вопрос</h3>
//
//import axios from 'axios'
// import React, { useEffect, useState } from 'react'
...
// //   data: T[]
// // }
//answ: type CommonResponseType<T = []> = {
//     total: number
//     messages: string[]
//     page: number
//     pageCount: number
